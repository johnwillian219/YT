// frontend/src/domains/auth/ui/oauth-buttons/GoogleOAuthButton.jsx
...
export default function GoogleOAuthButton({
  ...
  const getButtonClasses = () => {
    ...
    return `${baseClasses} ${themeStyles[theme] || themeStyles.cyberpunk} ${className}`;
  };

  return (
    <button className={getButtonClasses()} type="button" onClick={onClick}>
